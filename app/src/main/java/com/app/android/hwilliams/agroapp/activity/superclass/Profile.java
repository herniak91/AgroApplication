...
import com.app.android.hwilliams.agroapp.activity.Administracion;
...
public class Profile extends ActionBarActivity {
    ...
    public class ProfilePost extends AsyncTask<Map, Integer, JSONObject> {
        @Override
            ...
            try {
                if (jsonObject.getInt("code") == 0) {
                    ...
                    if(response.has("admin"))
                        getIntent().putParcelableArrayListExtra(Administracion.EXTRA_GROUPS, (ArrayList<? extends Parcelable>) PerfilUtils.getAdminData(response.get("admin").toString()));
                }else{
